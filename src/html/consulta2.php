<?php
include '../clases/filtroConsulta2.php';
?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="../assets/images/logos/ki.png" />
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <small class="text-muted float-end">Busqueda de Productos</small>
                            </div>
                            <div class="card-body">
                                            ...
                                            <td style="text-align: center;">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalActualizar" onclick="actualizar2('<?php echo $ver[0] ?>', '<?php echo $ver[1] ?>', '<?php echo $ver[2] ?>' , '<?php echo $ver[3] ?>', '<?php echo $ver[4] ?>', '<?php echo $ver[5] ?>')"><i class="bx bx-detail me-1"></i>Actualizar Producto</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="#" id="frmActualizar2" method="post">
                                <div class="row g-2">
                                    <div class="col mb-0">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="btnActualizar2" name="btnActualizar2" class="btn btn-primary">Guardar Cambios</button>
                        </div>
                    </div>
                </div>
            </div>
